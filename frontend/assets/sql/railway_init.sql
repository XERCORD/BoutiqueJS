-- Initialisation pour Railway : base fournie par MYSQLDATABASE (souvent "railway").
-- Dans Railway : service MySQL → onglet Data / Query, choisir la base "railway",
-- puis coller et exécuter ce fichier ENTIER.
-- Ensuite exécute 4images.sql puis (optionnel) 1image.sql ou 2images.sql.
